...
注意"输入端悬空时和逻辑1状态等效"这句话，这个文章的例子是个穆尔时序电路，因为他没有输入，而是自己搞自己，通过"输入端悬空时和逻辑1状态等效"来启动，所以这个例子初始状态是111，所以穆尔时序电路的状态图就是类似于这种形状<img src="https://img-blog.csdnimg.cn/20200106151053134.png"/> 由一个初始状态开始，进入一个循环体。<br/>
时序图好像都是从低电压开始，即0开始 (有待确认)
